...
public class EstadisticasResponse {
    ...
    private List<PuntoTemporalResponse> evolucionPh;
    private List<PuntoTemporalResponse> evolucionTemperatura;
    ...
    public static class PuntoTemporalResponse {
        private final String fecha;
        private final Double valor;
        public PuntoTemporalResponse(String fecha, Double valor) {
            this.fecha = fecha; this.valor = valor;
        }
        public String getFecha() { return fecha; }
        public Double getValor() { return valor; }
    }

    public static class AlertaResumenResponse {
        private final Long id;
        private final String nivel;
        private final String mensaje;
        @JsonFormat(pattern = "yyyy-MM-dd'T'HH:mm:ss")
        private final LocalDateTime fecha;
        public AlertaResumenResponse(Long id, String nivel, String mensaje, LocalDateTime fecha) {
            this.id = id; this.nivel = nivel; this.mensaje = mensaje; this.fecha = fecha;
        }
    ...
    public static class EventoResumenResponse {
        private final Long id;
        private final String descripcion;
        private final String magnitud;
        @JsonFormat(pattern = "yyyy-MM-dd'T'HH:mm:ss")
        private final LocalDateTime fecha;
        public EventoResumenResponse(Long id, String descripcion, String magnitud, LocalDateTime fecha) {
    ...
    public List<PuntoTemporalResponse> getEvolucionPh() { return evolucionPh; }
    public void setEvolucionPh(List<PuntoTemporalResponse> v) { this.evolucionPh = v; }
    public List<PuntoTemporalResponse> getEvolucionTemperatura() { return evolucionTemperatura; }
    public void setEvolucionTemperatura(List<PuntoTemporalResponse> v) { this.evolucionTemperatura = v; }
    ...
    public List<AlertaResumenResponse> getAlertas() { return alertas; }
    public void setAlertas(List<AlertaResumenResponse> v) { this.alertas = v; }
    ...
    public List<EventoResumenResponse> getEventos() { return eventos; }
    public void setEventos(List<EventoResumenResponse> v) { this.eventos = v; }
